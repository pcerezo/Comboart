...
public class HeroKnight : Personaje {
    ...
    public HeroKnight()
    {
        Debug.Log("Constructor de HeroKnight");
        vidaMax = vida = 100;
        ataqueFisico = 15;
        defensaFisica = 15;
        ataqueMagico = 5;
        ...
        Movimiento espadazo = new Movimiento("Espadazo", 12, "ataque_fisico");
    ...
    void Start ()
    {
        // cargar la animación principal indicando la ruta
...
/*
        ...
        GetComponent<SpriteRenderer>().sprite = Resources.Load("Assets/MedievalWarrior/Sprites/Idle") as Sprite;
        //m_animator = Resources.Load<Animator>("Assets/MedievalWarrior/Animations/Idle_0");
        Movimiento espadazo = new Movimiento("Espadazo 1", 5, "ataque_fisico");
        Movimiento tajo = new Movimiento("Tajo rápido", 2, "ataque_fisico");
        Movimiento espadazo2 = new Movimiento("Espadazo 2", 8, "ataque_fisico");
        Movimiento escudo = new Movimiento("Escudo", 5, "subir_defensa_fisica");
